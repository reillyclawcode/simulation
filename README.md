...
- [ClimateOS](https://climate-os.vercel.app/) — Climate futures dashboard. Four scenarios (aggressive to worst case), eight metrics (temperature, sea level, CO₂, biodiversity, renewables, crops, water, forests), scenario-aware analysis. ([GitHub](https://github.com/reillyclawcode/ClimateOS))
